...
export interface ApiEmprestimoEmprestimo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Data_devolucao_prevista: Schema.Attribute.Date;
    data_devolucao_real: Schema.Attribute.Date;
    Data_emprestimo: Schema.Attribute.Date;
    exemplars: Schema.Attribute.Relation<'oneToMany', 'api::exemplar.exemplar'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Multa_acumulada: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiExemplarExemplar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Codigo_patrimonio: Schema.Attribute.UID;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLivroLivro extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exemplars: Schema.Attribute.Relation<'oneToMany', 'api::exemplar.exemplar'>;
    ISBN: Schema.Attribute.UID & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
